...
export const registerUser = (username, age, phone, password, profilePic) => {
  return new Promise((resolve, reject) => {
    db.transaction((tx) => {
      tx.executeSql(
        'INSERT INTO users (username, age, phone, password, profilePic) VALUES (?, ?, ?, ?, ?)',
        [username, age, phone, password, profilePic],
